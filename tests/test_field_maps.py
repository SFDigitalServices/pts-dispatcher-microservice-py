...
@pytest.mark.parametrize('name, expected', [('state_fields', 'states.json'), ('building_use', 'building_use.json'), \
    ('fire_rating', 'fire_rating.json'), ('construction_type', 'construction_type.json'), ('occupancy_code', 'occupancy_code.json'), \
